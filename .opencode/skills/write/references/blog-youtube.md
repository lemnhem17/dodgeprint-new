...
python .opencode/skills/youtube/scripts/vidcap.py info "$URL"
python .opencode/skills/youtube/scripts/vidcap.py summary "$URL" --screenshot
python .opencode/skills/youtube/scripts/vidcap.py caption "$URL" --locale en --ext vtt
```
