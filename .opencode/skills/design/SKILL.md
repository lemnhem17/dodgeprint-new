---
name: ckm:design
description: Entry point for design tasks. Routes to brand (brand identity, voice, assets), design-system (tokens, component specs), or ui-styling (implementation). Use for design decisions, visual consistency, design system creation.
...
Umbrella skill coordinating brand, design-system, and ui-styling.
...
|------|-------|-------------|
| Logo, colors, voice, assets | `brand` | Brand identity system |
