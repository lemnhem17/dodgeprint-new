...
python .claude/skills/youtube/scripts/vidcap.py info "$URL"
python .claude/skills/youtube/scripts/vidcap.py summary "$URL" --screenshot
python .claude/skills/youtube/scripts/vidcap.py caption "$URL" --locale en --ext vtt
```
